  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-3xl font-bold text-ink">Validation queue</h1>
      </div>

      <div className="mb-6 grid gap-4 rounded-md border border-line bg-white p-4 md:grid-cols-2">
